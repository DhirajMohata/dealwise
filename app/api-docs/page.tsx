...
function CodeBlock({ code, language = 'json' }: { code: string; language?: string }) {
  ...
  return (
    <div className="relative rounded-xl border border-[#E5E7EB] bg-[#1E1E2E] text-sm">
...
export default function ApiDocsPage() {
      ...
      <div className="mx-auto max-w-4xl px-4 pb-24 pt-24 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          <div className="mb-4 flex items-center gap-3">
            ...
            <h1 className="text-3xl font-bold text-[#111827] sm:text-4xl">API Documentation</h1>
          </div>
        ...
        <div className="mb-10 grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[#E5E7EB] bg-white p-5 shadow-sm">
            ...
            <h3 className="text-sm font-semibold text-[#111827]">Free During Early Access</h3>
            <p className="mt-1 text-xs text-[#6B7280]">No API key required. All endpoints are open.</p>
          </div>
          <div className="rounded-xl border border-[#E5E7EB] bg-white p-5 shadow-sm">
            <Shield className="mb-3 h-5 w-5 text-emerald-600" />
            <h3 className="text-sm font-semibold text-[#111827]">No Authentication</h3>
            <p className="mt-1 text-xs text-[#6B7280]">No signup or tokens needed. Just POST and go.</p>
          </div>
          <div className="rounded-xl border border-[#E5E7EB] bg-white p-5 shadow-sm">
            <Clock className="mb-3 h-5 w-5 text-amber-600" />
            <h3 className="text-sm font-semibold text-[#111827]">Rate Limited</h3>
            <p className="mt-1 text-xs text-[#6B7280]">10 requests per minute per IP address.</p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <section className="rounded-2xl border border-[#E5E7EB] bg-white p-6 shadow-sm sm:p-8">
            <div className="mb-6 flex items-center gap-3">
              ...
              <code className="text-sm font-semibold text-[#111827]">/api/analyze</code>
            </div>
            ...
            {/* Request Body */}
            <h3 className="mb-3 text-sm font-semibold text-[#111827]">Request Body</h3>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="text-[#4B5563]">
                  {[
                    ...
                    <tr key={row.field} className="border-b border-[#E5E7EB]">
            ...
            {/* Response Schema */}
            <h3 className="mb-3 text-sm font-semibold text-[#111827]">Response Schema</h3>
            <div className="mb-6 overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-[#E5E7EB] text-xs font-medium uppercase tracking-wider text-[#6B7280]">
            ...
            {/* Error Responses */}
            <h3 className="mb-3 text-sm font-semibold text-[#111827]">Error Responses</h3>
            <div className="mb-6 overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-[#E5E7EB] text-xs font-medium uppercase tracking-wider text-[#6B7280]">
                ...
                <tbody className="text-[#4B5563]">
                  {[
                    ...
                    <tr key={row.status} className="border-b border-[#E5E7EB]">
          ...
          <section className="space-y-4">
            <h3 className="text-lg font-semibold text-[#111827]">Example Request</h3>
            <CodeBlock
              language="bash"
  ...
  -d '{
    ...
    "currency": "USD"
          ...
          {/* Example Response */}
          <section className="space-y-4">
            <h3 className="text-lg font-semibold text-[#111827]">Example Response</h3>
            <CodeBlock
              language="json"
              code={`{
  "overallScore": 35,
