...
import { Sparkles, Shield, Zap, CreditCard, ArrowLeft, Mail, Lock, User, Loader2, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F3F4F8] px-4">
      ...
      >
        ...
        <Link
          href="/"
          className="mb-6 inline-flex items-center gap-1.5 text-sm text-[#4B5563] transition-colors hover:text-[#111827]"
        >
        ...
        {/* Card */}
        <div className="relative overflow-hidden rounded-2xl border border-[#E5E7EB] bg-white p-8 shadow-lg">
          {/* Top gradient line */}
          ...
          <div className="mb-6 text-center">
            ...
            <h1 className="text-2xl font-bold text-[#111827]">
              {activeTab === 'signin' ? 'Sign in to DEALWISE' : 'Create your account'}
            </h1>
