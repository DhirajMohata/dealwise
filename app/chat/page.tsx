        ...
        <AnimatePresence initial={false}>
          {sidebarOpen && (
            <motion.aside
              ...
              className="flex h-[calc(100vh-64px)] shrink-0 flex-col overflow-hidden border-r border-[#E5E7EB] bg-white"
            >
              <div className="flex items-center justify-between border-b border-[#E5E7EB] p-4">
                <h2 className="text-sm font-semibold text-[#111827]">Contract History</h2>
                <button
                  onClick={() => setSidebarOpen(false)}
                  className="rounded-lg p-1 text-[#9CA3AF] transition-colors hover:bg-[#F3F4F8] hover:text-[#111827]"
                >
              ...
              <div className="flex-1 overflow-y-auto p-3">
                {history.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-xs text-[#9CA3AF]">No contract history yet</p>
                    <Link
                      href="/analyze"
                        ...
                        <button
                          ...
                          className={`w-full rounded-xl p-3 text-left transition-all ${
                            isSelected
                              ...
                              : 'border border-transparent hover:border-[#E5E7EB] hover:bg-[#FAFBFE]'
                          }`}
                        >
                          <p className={`truncate text-sm font-medium ${isSelected ? 'text-indigo-700' : 'text-[#111827]'}`}>
              ...
              {selectedContract && (
                <div className="border-t border-[#E5E7EB] p-3">
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-1.5 rounded-lg border border-[#E5E7EB] bg-[#FAFBFE] px-3 py-2 text-xs font-medium text-[#6B7280] transition-colors hover:bg-white hover:text-[#111827]"
                  >
          ...
          <div className="flex items-center gap-3 border-b border-[#E5E7EB] bg-white px-6 py-3">
            {!sidebarOpen && (
              <button
                ...
                className="rounded-lg p-1.5 text-[#9CA3AF] transition-colors hover:bg-[#F3F4F8] hover:text-[#111827]"
              >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold text-[#111827]">Contract AI Assistant</p>
            ...
            {messages.length === 0 ? (
              ...
              <div className="flex h-full flex-col items-center justify-center">
                ...
                >
                  ...
                  <p className="mb-8 max-w-md text-sm text-[#6B7280]">
                  ...
                  <div className="grid max-w-lg grid-cols-1 gap-3 sm:grid-cols-2">
                    {[
                      ...
                      <button
                        ...
                        className="rounded-xl border border-[#E5E7EB] bg-white p-3 text-left text-xs text-[#4B5563] transition-all hover:border-indigo-200 hover:bg-indigo-50/50 hover:text-[#111827]"
                      >
                        {suggestion}
                      </button>
                    ))}
            ...
            <div className="mx-auto flex max-w-3xl items-end gap-3">
              <div className="relative flex-1">
                <textarea
                  ...
                  rows={1}
                  className="max-h-32 w-full resize-none rounded-xl border border-[#E5E7EB] bg-[#FAFBFE] px-4 py-3 text-sm text-[#111827] placeholder-[#9CA3AF] outline-none transition-colors focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100"
              ...
              <button
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white shadow-md transition-all hover:shadow-lg disabled:opacity-50 disabled:shadow-none"
              >
                {loading ? (
